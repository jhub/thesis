...
roslaunch cwru_turtlebot one_robot.launch stationary:=false sensor_record:=true noisy:=true gps:=true sim_time:=240 state_tracker:=True comp_one:=True gui:=true
